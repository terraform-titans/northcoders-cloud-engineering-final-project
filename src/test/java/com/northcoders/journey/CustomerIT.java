package com.northcoders.journey;

import com.northcoders.customer.*;
...
public class CustomerIT {
    ...
    void canRegisterCustomer() {
        ...
        String email = fakerName.lastName() + "-" + UUID.randomUUID() + "@northcoders.com";
    ...
    void canDeleteCustomer() {
        ...
        CustomerRegistrationRequest request2 = new CustomerRegistrationRequest(name, email + ".uk", "password", age);
    ...
    void canUploadAndDownloadProfilePictures() throws IOException {
        ...
        Resource image = new ClassPathResource(
                "%s.jpeg".formatted("male".toLowerCase())
        );
